  ...
  return (
    <div className="grid gap-8">
      ...
      <div className="text-center">
        ...
        <div className="relative bg-[#181A20] rounded-2xl px-8 pt-8 pb-14 text-left min-h-[340px] mx-auto max-w-[700px] text-white font-sans">
          ...
          <div className="text-[18px] mb-6">
            ...
            <span className="font-bold">May 16–18 at the AICC</span> to explore
            advancements in{" "}
            <span className="font-bold">
          ...
          <div className="font-bold text-[18px] mt-6">
            #ETEX #ETEX2025 #DigitalEthiopia #TechForAfrica #Innovation
            #EthiopiaTech #DigitalTransformation
          </div>
          <button
            className="absolute right-6 bottom-4 px-6 py-2 bg-[#101B3A] text-white rounded-lg text-[16px] font-medium shadow-md hover:bg-[#00FFF0] hover:text-[#0b1030] transition-colors duration-200"
            onClick={() =>
