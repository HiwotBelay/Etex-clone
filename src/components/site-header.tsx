...
export function SiteHeader() {
  ...
  return (
    <header
      className={`w-full text-foreground py-4 px-5 border-b border-border-accent fixed top-0 z-50 transition-all duration-300 h-[120px] flex items-center ${headerClass}`}
    >
